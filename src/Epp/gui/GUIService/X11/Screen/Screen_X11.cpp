...
Screen_X11::Screen_X11(const String &title, i32 w, i32 h, Color::Type colorType, Rot rot) :
	...
	this->cx11->window = ::XCreateSimpleWindow( //
			this->cx11->display, //
			DefaultRootWindow(this->cx11->display), //
			0, 0, //
			this->w, this->h, //
			1, //
	...
	this->cx11->img = ::XCreateImage(	//
			this->cx11->display,	//
			DefaultVisual(this->cx11->display, DefaultScreen(this->cx11->display)),	//
			DefaultDepth(this->cx11->display, DefaultScreen(this->cx11->display)),	//
			ZPixmap,	//
			0,	//
			(c8*) this->fb,	//
			this->w, this->h, this->bpp,	//
			0	//
			);
